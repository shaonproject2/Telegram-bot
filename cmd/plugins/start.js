module.exports = {
  ...
  start: async ({ event, api, config }) => {
      ...
      const caption = `Hi ${user.first_name}! Welcome to SHAON-BOT. I'm a Telegram bot created by SHAON AHMED to help you 😄. Please type /menu to see all our menu lists.`;
